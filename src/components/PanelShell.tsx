...
export function PanelShell({
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.35rem] border border-[#23304b] bg-[linear-gradient(180deg,rgba(10,17,31,0.96),rgba(5,10,20,0.98))] p-3 shadow-[0_24px_60px_rgba(0,0,0,0.32)] sm:rounded-[1.6rem] sm:p-4">
