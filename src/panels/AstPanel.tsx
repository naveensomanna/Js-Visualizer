    ...
    >
      {parsed.error || !parsed.ast ? (
        ...
        <div className="space-y-4">
          ...
          <div className="overflow-auto rounded-[1.2rem] border border-[#24324f] bg-[radial-gradient(circle_at_top,rgba(96,165,250,0.08),transparent_30%),linear-gradient(180deg,rgba(8,14,26,0.96),rgba(5,10,20,0.99))] p-3 sm:rounded-3xl sm:p-4">
            <div className="min-w-[520px] rounded-[1.15rem] border border-white/5 bg-black/10 p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] sm:min-w-[640px] sm:rounded-[1.4rem] sm:p-4">
              <AstTreeNode
                label="root"
